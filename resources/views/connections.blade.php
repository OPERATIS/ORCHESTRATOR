...
@section('content')
    ...
    <div>
        ...
        <br>
        <a href="https://wa.me/{{config('integrations.whatsapp.displayPhoneNumber')}}?text={{urlencode('I want to receive alerts #' . $user->id)}}">WhatsApp</a>
        <br>
        <a href="https://m.me/{{config('integrations.messenger.pageName')}}?text={{urlencode('I want to receive alerts #' . $user->id)}}">Messenger</a>
        <br>
