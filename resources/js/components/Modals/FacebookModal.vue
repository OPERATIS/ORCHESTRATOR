<template>
    <div class="flex flex-col">
        <div class="flex flex-col text-black_5 text-2xl">
            <div class="mb-3">
                <img class="h-10 w-auto" src="/img/integrations/meta_ads.png" alt="meta ads">
            </div>
                ...
                <div class="w-full" :class="{'opacity-50': loading, 'hidden': item.delete}">
                    <div class="relative flex items-center border border-black border-opacity-10 px-4 mb-3.5"
                        ...
                        <div class="absolute flex items-center p-2 right-3 top-0 text-right">
                            ...
                            <span class="hover:fill-current hover:text-dangers cursor-pointer" @click="deleteAccount(item.id)">
        ...
        <div class="mt-[1.625rem]">
            <a :href="link" class="flex items-center justify-center cursor-pointer text-green_2 hover:opacity-75">
                <span class="mr-2">+</span> Add Meta Ads Account
            </a>
        </div>
...
export default {
    ...
    methods: {
        ...
        getAccountsData(){
            axios.get('/integrations/facebook')
                .then(({data}) => {
